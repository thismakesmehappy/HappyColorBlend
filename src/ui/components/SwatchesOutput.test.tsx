...
describe('SwatchesOutput Component', () => {
    ...
    test('renders with correct structure', () => {
        ...
        expect(screen.getByTestId('mock-swatch-group-color-Neutral')).toHaveTextContent('FFFFFF');
        expect(screen.getByTestId('mock-swatch-group-second-color-Neutral')).toHaveTextContent('000000');
