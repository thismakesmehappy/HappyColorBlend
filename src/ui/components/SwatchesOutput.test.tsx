...
describe('SwatchesOutput Component', () => {
    ...
    test('creates tone ramp with blended colors', () => {
        ...
        // The tone ramp is now generated by the store's buildToneRamp method
        ...
        const grayGroup = screen.getByTestId('mock-swatch-group-Gray');
        expect(grayGroup).toBeInTheDocument();
    });
